...
const parsedEnvironmentVariables: EnvironmentVariables =
  EnvValidation.environmentSchema.parse(rawEnvironmentVariables);

export class EnvConfig {
  public static readonly values: EnvironmentVariables = parsedEnvironmentVariables;
  public static readonly nodeEnvironment: EnvironmentVariables["NODE_ENV"] =
    EnvConfig.values.NODE_ENV;
