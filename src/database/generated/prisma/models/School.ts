...
export type SchoolOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "address" | "latitude" | "longitude", ExtArgs["result"]["school"]>;
...
export interface SchoolDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    groupBy<
        ...
        OrderByArg extends Prisma.True extends HasSelectOrTake ? { orderBy: SchoolGroupByArgs["orderBy"] } : { orderBy?: SchoolGroupByArgs["orderBy"] },
