import type {
    insertSchoolToDatabase as InsertSchoolResult
} from "../database/generated/prisma/sql/insertSchoolToDatabase";
import {SchoolResponse} from "../models/response/school-response.model";

export default class SchoolServiceHelper {
    public static toSchoolResponseList(
        results: InsertSchoolResult.Result[],
    ): SchoolResponse[] {
        return results.map(
    ...
    public static calculateDistanceInKilometers(
        userLatitude: number,
